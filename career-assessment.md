...
<head>
    ...
    <style>
      ...
      .avatar-wrapper::after { content: '📷'; position: absolute; bottom: 0; right: 0; background: var(--primary); border-radius: 50%; padding: 4px; font-size: 12px; border: 2px solid var(--sidebar); pointer-events: none;}
      ...
      .section-readonly { pointer-events: none; opacity: 0.6; filter: grayscale(30%); transition: 0.3s; }
      ...
      .mini-chart-container { height: 50px; margin-top: 15px; width: 100%; }
...
<div id="parentRibbon">👨‍👩‍👧 Viewing as Parent (Read-Only Mode)</div>
...
<div class="sidebar">
    ...
    <nav class="nav-menu">
        <button class="nav-btn active" onclick="switchTab('tab-home', this)">🏠 Dashboard</button>
        <button class="nav-btn" onclick="switchTab('tab-report', this)">📄 Career Report</button>
        <button class="nav-btn" onclick="switchTab('tab-explore', this)">📍 Career Lab</button>
        <button class="nav-btn" onclick="switchTab('tab-portfolio', this)">🎓 Academic Profile</button>
        <button class="nav-btn" onclick="switchTab('tab-counselling', this)">📅 Book Expert</button>
        <button class="nav-btn" onclick="switchTab('tab-chat', this)">💬 Direct Chat</button>
        ...
        <button class="nav-btn" style="color: #f87171;" id="logoutBtn">🚪 Secure Logout</button>
    </nav>
</div>
    ...
    <div class="main-content">
        ...
        <div id="tab-home" class="tab-content active">
            ...
            <div class="card" id="riskAlertBanner" style="display:none; margin-bottom: 25px; padding: 20px;">
                <h3 id="riskAlertTitle" style="border-bottom: none; padding-bottom: 0; font-size: 1.1rem; margin-bottom: 5px;">⚠️ Academic Alignment Warning</h3>
            ...
            <div class="grid-2" style="grid-template-columns: 1fr 1.5fr;">
                ...
                <div class="clarity-meter-wrap">
                    ...
                    <div id="dynamicMeterActionArea" style="margin-top: 15px; padding-top: 20px; border-top: 1px dashed rgba(255,255,255,0.1);">
                        <button onclick="launchAssessment()" id="dashActionBtn" class="btn protect-parent" style="width:100%; background:var(--accent); color:#0f172a;">Take Assessment ➔</button>
                    </div>
                    ...
                    <div id="lockCareerSection" class="protect-parent" style="display:none; margin-top: 15px; background: rgba(0,0,0,0.3); padding: 20px; border-radius: 16px; text-align: center; border: 1px dashed var(--accent);">
                        ...
                        <button onclick="lockFinalCareer()" class="btn" style="background: var(--accent); color: #0f172a; width: 100%;">🔒 Lock My Career Path</button>
                    </div>
                    ...
                    <div id="careerLockedSuccess" style="display:none; margin-top: 15px; background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 16px; text-align: center; border: 1px solid var(--success);">
                        <h4 style="margin: 0 0 10px 0; color: var(--success); font-size: 1.2rem;">🎉 Career Locked!</h4>
                        <p style="color: #cbd5e1; font-size: 0.9rem; margin-bottom: 15px;">Your parent has been notified. Time to execute the plan.</p>
                        <button class="btn btn-outline" style="color: white; border-color: white; width:100%;">📄 Download Final Roadmap</button>
                    </div>
                </div>

                <div>
                    <div class="card" style="border-top: 4px solid var(--primary); margin-bottom: 20px;">
                        <h3>🎯 Top Recommended Pathways</h3>
                        <div id="dashCareersContainer">
                            <div class="career-pill locked"><span>Engineering / Technology</span> <span>🔒</span></div>
                            <div class="career-pill locked"><span>Business Management</span> <span>🔒</span></div>
                            <div class="career-pill locked"><span>Psychology / Humanities</span> <span>🔒</span></div>
                    ...
                    <div class="card" style="background: #f8fafc; border-color: #bfdbfe; display: none;" id="dashAiNarrativeBox">
                        <h3 style="border-bottom-color: #bfdbfe; color: #1e40af;">🧠 Why These Match You</h3>
        ...
        <div id="tab-explore" class="tab-content">
            <div class="header-bar">
                ...
                <button class="btn" onclick="window.location.href='career-search.html'">Launch Interactive GPS ➔</button>
            </div>
            
            <div class="grid-2col">
                <div class="card protect-parent" style="border-top: 5px solid var(--secondary);">
                    <h3>⚖️ Compare Careers</h3>
        ...
        <div id="tab-report" class="tab-content">
            <div class="header-bar">
                ...
                <button class="btn btn-outline" disabled style="opacity:0.5; cursor:not-allowed;">🔒 Download PDF</button>
            </div>
            <div class="card" style="text-align:center; padding: 80px 20px;">
                ...
                <button onclick="launchAssessment()" class="btn protect-parent" style="padding: 15px 35px;">Take Assessment Now ➔</button>
            </div>
        </div>
        ...
        <div id="tab-portfolio" class="tab-content">
            <div class="header-bar">
                ...
                <button class="btn btn-outline" onclick="alert('Auto-resume builder coming soon!')">📄 Generate Smart Resume</button>
            </div>
            ...
            <div class="grid-2">
                ...
                <div>
                    <div class="card protect-parent" style="border-top: 5px solid var(--accent); margin-bottom: 20px;">
                        <h3>🏆 Extra-Curriculars & Internships</h3>
                    ...
                    <div class="card" style="border-top: 5px solid var(--secondary); margin-bottom: 0;">
                        ...
                        <div class="resource-item" style="padding: 10px 15px;">
                            <div><strong style="color:#0f172a; display:block;">Understanding RIASEC</strong><span style="font-size:0.8rem; color:var(--text-muted);">PDF • Dispatched by Admin</span></div>
            ...
            <div class="grid-3-1">
                <div class="card protect-parent" style="border-top: 5px solid var(--secondary);">
                    ...
                    <div id="bookingAvailInfo" style="margin-bottom: 25px; padding: 20px; background: #f8fafc; border: 1px solid var(--border); border-radius: 12px; display:none;">
                        ...
                        <div style="display:flex; justify-content:space-between; border-top: 1px dashed var(--border); padding-top:10px; margin-top:10px;"><span style="color:#64748b; font-weight:bold; font-size:0.85rem; text-transform:uppercase;">Consultation Fee</span><span style="color:var(--success); font-weight:900; font-size:1.1rem;">₹1,999</span></div>
                    </div>
                    <div class="form-group">
                    ...
                    <p style="color: var(--danger); font-size: 0.85rem; font-weight: bold; text-align: center; margin-bottom: 10px;">🔥 Only 3 expert slots left this week.</p>
                ...
                <div class="card" style="background: #1e293b; color: white; border: none;">
                    ...
                    <div style="margin-top:30px; text-align:center;"><span style="font-size:3rem;">⭐</span><p style="font-weight:bold; margin-top:10px;">4.9/5 Average Rating</p></div>
                </div>
            </div>
        </div>
            ...
            <div class="grid-3-1">
                <div class="card protect-parent" style="padding:0; overflow:hidden; display:flex; flex-direction:column; height:60vh; border-top: 5px solid var(--primary);">
                    <div style="padding: 20px 25px; border-bottom: 1px solid var(--border); background: #f8fafc;">
                        ...
                        <p id="counsellorReplyText" style="font-size: 0.85rem; color: var(--success); margin: 10px 0 0 0; font-weight: bold; display: none;">🟢 Typically replies within 2 hours</p>
                    </div>
                ...
                <div>
                    ...
                    <button class="btn btn-outline" style="width:100%; border-color:var(--accent); color:var(--accent);">🤖 Ask Career AI (Instant FAQ)</button>
                </div>
            </div>
        </div>
        ...
        <div id="tab-settings" class="tab-content">
            ...
            <div class="card protect-parent" style="border-top: 5px solid var(--primary);">
                ...
                <button class="btn" style="margin-top:30px; padding: 15px 30px;">💾 Save Details</button>
            </div>
        </div>
...
<script type="module">
    ...
    function renderMiniChart(score) {
        ...
        miniChartInstance = new Chart(ctx.getContext('2d'), {
            ...
            data: { 
                ...
                datasets: [{ data: [1, 3, score >= 7 ? 7 : score, score], borderColor: '#f59e0b', borderWidth: 2, pointRadius: 3, tension: 0.4 }] 
            },
            options: { 
        ...
        if(data.assessmentCompleted) {
            ...
            if(data.academic && data.academic.marks && data.riasecCode && (data.riasecCode.includes('I') || data.riasecCode.includes('R'))) {
                ...
                if (marks < 45) {
                    ...
                    title.style.color = '#e11d48'; title.innerText = '🚨 Critical Alignment Alert';
                    ...
                    title.style.color = '#d97706'; title.innerText = '⚠️ Strong Alignment Warning';
                    ...
                    title.style.color = '#f59e0b'; title.innerText = '🟡 Mild Alignment Note';
            ...
            // Populate Careers Preview (Weighted Narrative)
            if(data.riasecCode) {
                ...
                if((r.includes('I') && r.includes('R')) || (r.includes('I') && r.includes('C'))) {
                    career1 = "Engineering / Tech / Data"; match1 = "🔥 Strong Match";
                    career2 = "Research / Science"; match2 = "⭐ Good Match";
                    ...
                    career1 = "Psychology / Humanities"; match1 = "🔥 Strong Match";
                    career2 = "Design / Media / Education"; match2 = "⭐ Good Match";
                    textMatch = "Your profile suggests strong alignment with creative, human-centric, and expressive roles. You draw energy from connecting with others and thinking outside the box.";
                } else if (r.includes('E') && r.includes('C')) {
                    career1 = "Business / Management"; match1 = "🔥 Strong Match";
                    career2 = "Finance / Operations"; match2 = "⭐ Good Match";
                    textMatch = "Your profile suggests natural energy toward leadership, organization, and structured execution. Roles requiring strategic decision-making suit you well.";
                } else if (r.includes('I') && r.includes('S')) {
                    career1 = "Medicine / Healthcare"; match1 = "🔥 Strong Match";
                    career2 = "Clinical Sciences"; match2 = "⭐ Good Match";
                    textMatch = "Your profile blends analytical rigor with a strong desire to help others, making healthcare and clinical sciences a highly rewarding potential pathway.";
                } else {
                    career1 = "Interdisciplinary Roles"; match1 = "🔥 Strong Match";
                    career2 = "Management / Consulting"; match2 = "⭐ Good Match";
                    textMatch = "Your profile shows a unique blend of traits. You are likely to thrive in interdisciplinary roles that combine strategy with execution.";
                }
    ...
    // --- LOCK UI LOGIC ---
    function lockUI() {
        document.querySelectorAll('#comp1, #comp2, #portMarks, #portStream, #portStrong, #portWeak, .btn-save-academic').forEach(el => el.disabled = true);
        const actionBtn = document.getElementById('dashActionBtn');
        if(actionBtn) {
            actionBtn.style.display = 'block';
            actionBtn.innerText = "🔒 Assessment Locked";
    ...
    window.runComparison = function() {
        ...
        const dbMock = {
            "btech": { name: "B.Tech (CSE)", diff: "Hard", sal: "₹25L+", risk: "Low", math: "Yes" },
            "bba": { name: "BBA / MBA", diff: "Medium", sal: "₹20L+", risk: "Medium", math: "No" },
            "psych": { name: "Clinical Psych", diff: "Medium", sal: "₹15L+", risk: "Low", math: "No" },
            "mbbs": { name: "MBBS (Doctor)", diff: "Very Hard", sal: "₹30L+", risk: "Very Low", math: "No" },
            "law": { name: "Corporate Law", diff: "Hard", sal: "₹25L+", risk: "Medium", math: "No" }
        };
    ...
    window.loadCounsellorChat = function(counsellorId) {
        ...
        chatBox.innerHTML = `
            <div style="text-align:center; color:var(--text-muted); margin-bottom: 25px; font-size:0.85rem; padding: 5px 15px; background: #f1f5f9; border-radius: 50px; display:inline-block; margin-left: 50%; transform: translateX(-50%);">🔒 Secure connection established.</div>
