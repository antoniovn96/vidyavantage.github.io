---
layout: default
title: "Aditya Academy of Architecture and Design (AAAD) 🎓"
permalink: /colleges/aditya-architecture/
image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
description: "Browse B.Arch and B.Sc Interior Design programs at Aditya Academy of Architecture and Design (AAAD), Bangalore."
---

<meta property="og:title" content="AAAD Bangalore Course Portal 🎓">
<meta property="og:description" content="Access details for Architecture and Interior Design courses at AAAD. Check 2025 Fees, NATA Eligibility, and Admission details.">
<meta property="og:image" content="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80">
...
<style>
  ...
  /* 2. HERO SECTION */
  .aaad-hero {
    background: linear-gradient(rgba(69, 90, 100, 0.85), rgba(0, 0, 0, 0.7)), url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80');
  ...
  .aaad-hero h1 { font-size: 2.8rem; margin: 0; font-weight: 800; color: white !important; }
  .aaad-hero p { font-size: 1.1rem; color: #f0f0f0 !important; margin-top: 10px; max-width: 700px; margin-left: auto; margin-right: auto; }
  ...
  .filters-sidebar {
    ...
    position: sticky;
    top: 90px;
    border-top: 4px solid #455A64; /* Blue Grey Theme */
    flex-shrink: 0;
  }

  .filter-group { margin-bottom: 20px; }
  .filter-label { display: block; font-weight: 700; margin-bottom: 8px; color: #455A64; font-size: 0.9rem; }
  ...
  .filter-input:focus, .filter-select:focus { border-color: #455A64; }
  ...
  .course-card:hover { transform: translateY(-3px); box-shadow: 0 8px 25px rgba(0,0,0,0.08); border-left-color: #455A64; }

  /* Department Colors */
  .dept-Arch { border-left-color: #455A64; } /* Blue Grey */
  .dept-Design { border-left-color: #00796B; } /* Teal */
  ...
  .view-btn {
    background: transparent; border: 1px solid #455A64; color: #455A64;
    padding: 6px 15px; border-radius: 50px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: 0.2s;
  }
  .view-btn:hover { background: #455A64; color: white; }
  ...
  .modal-header {
    background: #455A64; padding: 20px 25px; color: white; display: flex; justify-content: space-between; align-items: center;
  ...
  .info-head { font-size: 0.95rem; font-weight: 700; color: #455A64; border-bottom: 2px solid #f0f0f0; padding-bottom: 5px; margin-bottom: 10px; display: flex; align-items: center; gap: 8px; }
  ...
  .fee-table td:last-child { text-align: right; font-weight: bold; color: #455A64; }
...
<div class="aaad-hero">
  <h1>Aditya Academy of Architecture and Design (AAAD)</h1>
  <p>Approved by Council of Architecture (COA) | Affiliated to VTU | A Unit of Aditya Group of Institutions</p>
</div>
...
<div class="app-container">
  ...
  <aside class="filters-sidebar">
    <div class="filter-group">
      ...
      <input type="text" id="searchInput" class="filter-input" placeholder="e.g. Architecture, Interior..." onkeyup="renderCourses()">
    </div>
    ...
    <div class="filter-group">
      ...
      <select id="levelFilter" class="filter-select" onchange="renderCourses()">
        ...
        <option value="UG">Undergraduate (B.Arch / B.Sc)</option>
      </select>
    </div>
  ...
  <div class="modal-box">
    ...
    <div class="modal-body">
      ...
      <div style="text-align:center; margin-top:30px;">
        <a href="https://aditya.ac.in/architecture" target="_blank" style="background:#455A64; color:white; padding:12px 30px; border-radius:50px; text-decoration:none; font-weight:bold;">Official Website ↗</a>
      </div>
...
<script>
  ...
  const courses = [
    ...
    { 
      id: 2, 
      name: "B.Sc. in Interior Design & Decoration", 
      dept: "Design", 
      level: "UG", 
      fee: { 
        "Tuition Fee": "₹1,00,000 - ₹1,50,000 / year" 
      }, 
      elig: "Passed 10+2 (PUC/CBSE/ISC) or equivalent in any stream from a recognized board.", 
      career: "Interior Designer, Space Planner, Furniture Designer, Retail Space Consultant." 
    }
  ];
  ...
  function renderCourses() {
    ...
    courses.forEach(course => {
      ...
      if (matchSearch && matchLevel && matchDept) {
        ...
        let duration = course.dept === 'Arch' ? '5 Years' : '3 Years';
  ...
  function getDeptName(code) {
    ...
    if (code === 'Design') return 'Interior Design';
    return code;
  }
  ...
  function openDetails(id) {
    ...
    let process = "Direct admission based on merit (10+2 marks) and personal interview.";
    if (course.dept === 'Arch') {
