...
<main>
    ...
    <div class="section-wrap alt-bg" style="padding-bottom: 60px;">
      ...
      <div class="parents-box">
          ...
          <a href="#loginBoxUI" class="btn-outline" style="display:block; padding: 16px 30px; border-radius: 8px; font-weight: 800; text-decoration: none; max-width: 300px; margin: 0 auto;">See How Parent View Works ➔</a>
      </div>
    </div>
    ...
    <div class="section-wrap alt-bg">
      ...
      <div class="faq-container">
          <div class="faq-item" onclick="this.classList.toggle('active')">
              <div class="faq-question">Is this better than a school career test? <span class="faq-icon">+</span></div>
          ...
          <div class="faq-item" onclick="this.classList.toggle('active')">
              <div class="faq-question">What if my child changes interests later? <span class="faq-icon">+</span></div>
          ...
          <div class="faq-item" onclick="this.classList.toggle('active')">
              <div class="faq-question">Can parents attend the counselling sessions? <span class="faq-icon">+</span></div>
          ...
          <div class="faq-item" onclick="this.classList.toggle('active')">
              <div class="faq-question">Is this suitable for a Class 8 student? <span class="faq-icon">+</span></div>
