...
<style>
  ...
  .section-wrap { padding: 80px 20px; content-visibility: auto; contain-intrinsic-size: 800px; }
  ...
  .phil-text { flex: 1; }
  .phil-text h2 { font-size: 2rem; color: var(--primary); margin: 0 0 15px 0; font-weight: 800; letter-spacing: -0.5px;}
  ...
  .factor-item h3 { margin: 0 0 10px 0; color: var(--primary); font-size: 1.1rem; display: flex; align-items: center; gap: 10px;}
  ...
  .auth-card h3 { margin: 0 0 10px 0; color: var(--primary); font-size: 1.1rem;}

  /* --- TABLES --- */
  .data-table-wrapper { max-width: 1100px; margin: 0 auto 40px; overflow-x: auto; background: white; border-radius: 16px; box-shadow: var(--card-shadow); border: 1px solid #E5E7EB; -webkit-overflow-scrolling: touch;}
  ...
  .faq-answer { padding: 0 25px 24px; color: var(--text-muted); line-height: 1.6; }

  /* --- LEGAL DISCLAIMER --- */
  .legal-footer { text-align: center; padding: 40px 20px; background: #111827; color: #9CA3AF; font-size: 0.85rem; line-height: 1.5; content-visibility: auto;}
...
<main>
    ...
    <div class="visa-hero">
      <span class="hero-badge" aria-hidden="true">✈️ Global Education Pathways</span>
    ...
    <div class="section-wrap alt-bg" style="padding-top: 0;">
        ...
        <div class="lead-container">
            ...
            <form id="visaLeadForm">
                <div class="form-grid">
                    <input type="text" id="targetName" class="form-input" placeholder="Full Name" aria-label="Full Name" autocomplete="name" required aria-required="true">
                    <input type="tel" id="targetPhone" class="form-input" placeholder="10-Digit Mobile Number" aria-label="10-Digit Mobile Number" autocomplete="tel" pattern="[0-9]{10}" title="Please enter a valid 10-digit Indian phone number" required aria-required="true">
                    <input type="email" id="targetEmail" class="form-input" placeholder="Email Address" aria-label="Email Address" autocomplete="email" required aria-required="true">
                    <select class="form-select" id="targetDest" aria-label="Target Destination" required aria-required="true">
                    ...
                    <select class="form-select" id="targetType" aria-label="Visa Type" required aria-required="true">
                    ...
                    <select class="form-select" id="targetIntake" aria-label="Planned Intake" required aria-required="true">
                ...
                <p style="text-align:center; font-size:0.85rem; color:var(--text-muted); margin-top:15px; font-weight:bold;">
                    <span aria-hidden="true">🔒</span> Your data is secure and never shared with third parties.
                </p>
            </form>
        </div>
        
        <div class="disqualifier-box">
            <h3>⚠️ Who This Is NOT For</h3>
            <ul>
                <li><span aria-hidden="true">❌</span> Students applying purely for migration without genuine academic intent.</li>
                <li><span aria-hidden="true">❌</span> Applicants unwilling or unable to show verifiable financial proof.</li>
                <li><span aria-hidden="true">❌</span> Students unwilling to meet embassy academic and language proficiency requirements (IELTS/TOEFL).</li>
            </ul>
        </div>
    </div>
        ...
        <div class="free-package-box">
            ...
            <div class="package-grid">
                <div class="pkg-item">
                    ...
                    <h3 style="margin: 0 0 5px 0; color: #ffffff; font-size: 1.2rem;">1. Career Assessment</h3>
                    <span style="font-size: 0.9rem; color: #9ca3af;">Identify your true aptitude.</span>
                </div>
                <div class="pkg-item">
                    <div style="font-size: 2.5rem; margin-bottom: 10px;" aria-hidden="true">🏛️</div>
                    <h3 style="margin: 0 0 5px 0; color: #ffffff; font-size: 1.2rem;">2. University Mapping</h3>
                    <span style="font-size: 0.9rem; color: #9ca3af;">Get an unbiased shortlist.</span>
                </div>
                <div class="pkg-item">
                    <div style="font-size: 2.5rem; margin-bottom: 10px;" aria-hidden="true">🛂</div>
                    <h3 style="margin: 0 0 5px 0; color: #ffffff; font-size: 1.2rem;">3. Visa & SOP Support</h3>
    ...
    <div class="section-wrap alt-bg">
        ...
        <div class="case-study-box">
            <div class="cs-visual">
                <div style="font-size: 4rem; margin-bottom: 10px;" aria-hidden="true">🇮🇪</div>
                <h3 style="margin-bottom:0;">Ireland Transition</h3>
                <p style="color:var(--text-muted); font-size:0.9rem;">From Commerce to Data</p>
            </div>
            <div class="cs-content">
                <span class="cs-tag">MSc Data Analytics</span>
                <p style="margin: 0 0 15px 0; font-size: 1.5rem; color: #0f172a; font-weight: bold;">How a Class 12 Commerce student secured a top tech admit.</p>
    ...
    <div class="section-wrap">
      ...
      <div class="faq-container">
          <details class="faq-item">
              <summary>Do we need to show the entire 4-year tuition fee in our bank account?</summary>
          ...
          <details class="faq-item">
              <summary>What if the visa gets rejected?</summary>
          ...
          <details class="faq-item">
              <summary>How does your "100% Free" model actually work?</summary>
